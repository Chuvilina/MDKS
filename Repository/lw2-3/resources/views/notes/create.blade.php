...
<div class="container">
    ...
    <div class="w-100 rounded border border-3 border-danger bg-dark p-5 justify-content-between d-flex flex-column">
        ...
        <form class="justify-content-between d-flex flex-column" action="{{ route('note.store') }}" method="POST">
            @csrf
            ...
            <textarea name="description" class="form-control" class="input-group-text"></textarea>
            </div>
